...
fun DefaultListAppBar(
    ...
    TopAppBar(
        title = {
            Text(text = stringResource(R.string.default_appBar_title), color = MaterialTheme.colors.topAppBarContentColor)
        },
        actions = {
            ListAppBarActions(
...
fun ListAppBarActions(
    ...
    DeleteAllTasks(onDeleteAllConfirmed = { openDialog = true })
}
        ...
        TextField(
            ...
            placeholder = {
                Text(
                    ...
                    text = stringResource(R.string.search_appBar_placeholder),
                    color = Color.White
                )
            },
            textStyle = TextStyle(
            ...
            leadingIcon = {
                IconButton(
                    ...
                    Icon(
                        imageVector = Icons.Filled.Search,
                        contentDescription = stringResource(R.string.search_appBar_icon),
                        tint = MaterialTheme.colors.topAppBarContentColor
                    )
                }
            },
            trailingIcon = {
                IconButton(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.search_appBar_trailingIcon),
                        tint = MaterialTheme.colors.topAppBarContentColor
                    )
                }
            },
