...
fun AddAction(
    ...
    IconButton(onClick = { onAddClicked(Action.ADD) }) {
        Icon(
            ...
            contentDescription = stringResource(R.string.new_task_add_action_description),
            tint = MaterialTheme.colors.topAppBarContentColor
        )
    }
}
...
fun CloseAction(
    ...
    IconButton(onClick = { onCloseClicked(Action.NO_ACTION) }) {
        Icon(
            ...
            contentDescription = stringResource(R.string.close_action_description),
            tint = MaterialTheme.colors.topAppBarContentColor
        )
    }
}
...
fun ExistingTaskAppBarActions(
    ...
    DisplayAlertDialog(
        ...
        closeDialog = { openDialog = !openDialog },
...
fun DeleteAction(
    ...
    IconButton(onClick = { onDeleteClicked() }) {
        Icon(
            ...
            contentDescription = stringResource(R.string.delete_action_description),
            tint = MaterialTheme.colors.topAppBarContentColor
        )
    }
}
...
fun UpdateAction(
    ...
    IconButton(onClick = { onUpdateClicked(Action.UPDATE) }) {
        Icon(
            imageVector = Icons.Filled.Check,
            contentDescription = stringResource(R.string.update_action_description),
            tint = MaterialTheme.colors.topAppBarContentColor
        )
    }
}
